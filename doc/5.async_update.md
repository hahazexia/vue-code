...
响应式原理说到通过 Object.defineProperty 为对象的每个 key 设置 getter、setter，从而拦截对数据的访问和设置。
...
## /src/core/observer/dep.js dep.notify
...
## /src/core/util/next-tick.js nextTick
...
## /src/core/util/next-tick.js timerFunc
...
## /src/core/util/next-tick.js flushCallbacks
...
## /src/core/observer/scheduler.js flushSchedulerQueue
...
## /src/core/observer/watcher.js watcher.run
...
## /src/core/observer/watcher.js watcher.get
